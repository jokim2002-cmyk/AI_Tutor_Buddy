...
    api_key = os.getenv("AQ.Ab8RN6LmW5gAaOaK18lNnc3xfZskQM7GSCX8to8xMD-Md7PrVQ")
    if not api_key:
        page.add(ft.Text("Error: API Key not found! Please set GEMINI_API_KEY.", color="red"))
        return
        
...
    
    # Initialize Model with Session Memory
